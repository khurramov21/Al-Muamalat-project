...
const Home = () => {
  return (
    <div className='mx-auto w-full max-w-[1440px] max-h-[700px] bg-[#009688] relative'>
      <div className="w-full max-w-[1180px] h-full mx-auto relative px-4 sm:px-6 md:px-[50px]">
        <div className="flex flex-col lg:flex-row justify-between w-full">
          ...
          {/* RIGHT SIDE: IMAGE */}
          <div className="w-full max-w-[560px] h-auto mt-[80px] lg:mt-[155px] px-2 lg:px-0">
            <img src={headerImg} alt="Header visual" className="w-[600px] h-[600px] object-contain" />
          </div>
